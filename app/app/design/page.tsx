    ...
    <div className="min-h-screen pt-24 pb-16 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-light tracking-wide mb-4 text-gray-900 uppercase">
            {locale === 'es' ? 'Pre-Visualizador de IA' : 'AI PRE-VISUALIZER'}
          </h1>
          <div className="w-24 h-px bg-black mx-auto mb-6"></div>
          <p className="text-gray-600 max-w-2xl mx-auto">
            {locale === 'es' 
              ? 'Sube una foto de tu habitación y descubre cómo se verá nuestra colección. Luego cotiza tu material exacto.'
              : 'Upload a photo of your room to see how our collection looks. Then quote your exact material.'}
          </p>
        </div>
